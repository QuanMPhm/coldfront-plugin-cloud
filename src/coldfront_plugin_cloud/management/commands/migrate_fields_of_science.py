...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        mapping_dict = self._load_fos_map(mapping_csv)
    ...
    @staticmethod
    def _get_or_create_new_fos(description):
        new_fos, _ = FieldOfScience.objects.get_or_create(
            is_selectable=True,
    ...
    def _migrate_fos(self, mapping_dict):
        for project in Project.objects.all():
            ...
            if cur_fos_name in mapping_dict.keys():
                ...
                new_fos = self._get_or_create_new_fos(description=new_fos_name)
